export function CardProduct () {   
  return (
    <div className='px-2 py-3 h-[250px] md:w-[300px] md:h-[360px] mx-auto bg-gray-700 rounded-[13px] md:px-2 md:py-4 flex flex-col gap-1 cursor-pointer shadow-lg hover:shadow-none transition-shadow'>
      ...
      <div>
        ...
        <div>
          ...
          <p className="mt-2 text-center text-gray-200 md:mt-5 text-[14px]">em 12x R$15,42</p>
        </div>
      </div>
    </div>
  )

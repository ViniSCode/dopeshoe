...
// //   return (
// //     <div className="cursor-pointer relative border-b border-b-[#dbdbdb] p-2 border-lg w-full h-[100px] mx-auto flex items-center gap-2 last-of-type:mb-10">
// //       <div className="absolute top-2 right-2"></div>
// //       <div className="h-full w-full min-w-[75px] max-w-[75px] md:min-w-[100px] md:max-w-[100px] rounded-lg p-1">
...
// //         </div>
// //         <div className=" flex items-start justify-start gap-2">
// //           <p className="text-[15px] md:text-1xl font-medium text-black">
// //             {formattedDate}
// //           </p>
// //         </div>
// //       </div>
